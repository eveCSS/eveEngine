...
* die savescandescription-Funktionalität fehlt noch, dabei den QByteArray mit den XML-Daten in 
MessageFactory in einen Pointer umwandeln und in der AddPlMessage ein takeXMLData statt getXMLData, um das häufige umkopieren zu sparen.
